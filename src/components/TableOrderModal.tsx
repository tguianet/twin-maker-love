...
export function TableOrderModal() {
  ...
  return (
    <div
      ...
      role="presentation"
      onMouseDown={(event) => {
        if (event.target === event.currentTarget) setSelectedTable(null);
      }}
    >
      <div
        role="dialog"
      ...
      >
        <div className="flex h-[30px] shrink-0 select-none items-center justify-between border-b border-[#a0a0a0] bg-gradient-to-b from-[#e6e6e6] to-[#d4d4d4] px-2">
          ...
          <div className="flex h-full gap-[2px] py-[3px]">
            <button
              ...
              className="flex h-full w-[28px] items-center justify-center border border-[#a0a0a0] bg-[#e1e1e1] hover:bg-[#d0d0d0]"
            >
        ...
        <div className="flex h-[75px] shrink-0 items-center border-b border-[#d4d4d4] bg-white px-4">
          <div className="flex w-[250px] items-center">
            ...
            <div className="flex flex-col justify-center">
              <div className="mb-1 flex items-center gap-2">
                ...
                <span className="bg-[#32965d] px-2 py-[2px] text-xs font-semibold uppercase tracking-wider text-white">
                  Em Aberto
                </span>
              </div>
              <div className="text-xs text-gray-600">
                Iniciado em 28-08 às <strong>01:25</strong>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-1 items-center justify-end gap-4">
            ...
            <button type="button" className="flex items-center gap-2 border border-transparent px-2 py-1 font-bold text-[#0078d7] hover:border-blue-200 hover:bg-blue-50">
              <ActionIcon>▣</ActionIcon>
              <span className="text-[15px]">Produtos <span className="text-sm font-normal text-gray-500">(F3)</span></span>
            </button>
          </div>
        </div>
        ...
        <div className="flex min-h-0 flex-1 overflow-hidden bg-white">
          <aside className="flex w-[280px] shrink-0 flex-col border-r border-[#d4d4d4] bg-[#ececec]">
            <div className="flex flex-1 flex-col gap-5 overflow-y-auto p-4">
              <div>
                ...
                <select className="mb-3 w-full border border-[#abadb3] bg-white px-2 py-1.5 text-sm shadow-sm focus:border-[#0078d7] focus:outline-none">
                  <option>Tiago Gonçalves</option>
                </select>
                <textarea
                  className="h-[60px] w-full resize-none border border-[#abadb3] p-2 text-sm shadow-sm placeholder-gray-400 focus:border-[#0078d7] focus:outline-none"
              ...
              <div>
                ...
                <label className="flex cursor-pointer select-none items-center gap-3 text-gray-700">
                  <input type="checkbox" className="h-[22px] w-[44px] cursor-pointer accent-[#0078d7]" />
                  <span>Bloquear Pedido <span className="text-gray-500">(F8)</span></span>
                </label>
              </div>
            </div>

            <div className="mt-auto flex flex-col gap-4 p-4">
              <button type="button" className="flex w-full items-center gap-3 py-1 text-left font-bold text-[#0078d7] hover:text-blue-800">
                <ActionIcon>♙</ActionIcon>
                <span>Vincular Cliente <span className="font-normal text-gray-500">(F11)</span></span>
              </button>
              <button type="button" className="flex w-full items-center gap-3 py-1 text-left font-bold text-[#0078d7] hover:text-blue-800">
                <ActionIcon>☷</ActionIcon>
                <span>Mais Opções <span className="font-normal text-gray-500">(F12)</span></span>
              </button>
            </div>

            <div className="flex h-[60px] shrink-0 items-center border-t border-[#d4d4d4] bg-[#ececec] px-4">
              <button type="button" onClick={() => setSelectedTable(null)} className="flex w-full items-center gap-2 py-2 font-bold text-[#0078d7] hover:text-blue-800">
                <ActionIcon>‹</ActionIcon>
                <span className="text-[15px]">Voltar <span className="text-sm font-normal text-gray-500">(ESC)</span></span>
              </button>
            </div>
          </aside>
          ...
          <section className="flex min-w-0 flex-1 flex-col bg-white">
            ...
            <div className="flex h-[60px] shrink-0 items-center justify-between border-t border-[#d4d4d4] bg-white px-6">
              <button type="button" className="-ml-2 flex items-center gap-2 border border-transparent px-2 py-2 font-bold text-[#0078d7] hover:border-blue-200 hover:bg-blue-50">
                <ActionIcon>▧</ActionIcon>
                <span className="text-[15px]">Imprimir <span className="text-sm font-normal text-gray-500">(F9)</span></span>
              </button>
              <button type="button" disabled className="-mr-2 flex cursor-not-allowed items-center gap-2 px-2 py-2 font-bold uppercase tracking-wide text-gray-400">
                <ActionIcon>▱</ActionIcon>
                <span className="text-[15px]">Pagamento <span className="text-sm font-normal normal-case tracking-normal text-gray-400">(F5)</span></span>
              </button>
            </div>
          </section>
        </div>
