          ...
          >
            <div className="flex items-center justify-between border-b border-[#b0b0b0] bg-gradient-to-b from-[#eaeaea] to-[#d4d4d4] px-[10px] py-[6px]">
              ...
              <button
                ...
                className="flex h-5 w-6 items-center justify-center rounded-[2px] border border-[#a0a0a0] bg-gradient-to-b from-[#e0e0e0] to-[#c0c0c0] text-[12px] text-[#555] hover:border-[#e81123] hover:bg-[#e81123] hover:text-white"
              >
                X
              </button>
            </div>
            ...
            <div className="p-5">
              ...
              <div className="flex justify-end pt-[10px]">
                <button
                  ...
                  className="flex items-center gap-2 bg-transparent px-[10px] py-[5px] text-[14px] font-bold text-black hover:underline"
                >
